...
def info_bar(scene, player1_score, player2_score):
    ...
    text1 = font.render(f"Player 1 - Score: {player1_score}", True, (255, 255, 255))    # Creates a text surface with the score of player 1
    text2 = font.render(f"Player 2 - Score: {player2_score}", True, (255, 255, 255))
    text1_rect = text1.get_rect()                                                       # Creates a rectangle for the text surface
    text2_rect = text2.get_rect()
    text1_rect.left = 10
    text2_rect.right = scene.get_width() - 10
    text1_rect.top = 10
    text2_rect.top = 10
    scene.blit(text1, text1_rect)                                                       # Blits the text surface on the screen
